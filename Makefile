...
fakeglp_weth_localhost: deploy_fakeglp_weth_localhost
	NETWORK=localhost USE_WETH=1 forge script script/AddFakeGLPLiquidity.s.sol --rpc-url http://127.0.0.1:8545 -vv --broadcast
...
deploy_fakeglp_localhost:
	NETWORK=localhost USE_WETH=0 forge script script/DeployFakeGLPMarket.s.sol --rpc-url http://127.0.0.1:8545 --broadcast
	python3 python/consolidate_config.py
deploy_fakeglp_weth_localhost:
	NETWORK=localhost USE_WETH=1 forge script script/DeployFakeGLPMarket.s.sol --rpc-url http://127.0.0.1:8545 --broadcast
	python3 python/consolidate_config.py
