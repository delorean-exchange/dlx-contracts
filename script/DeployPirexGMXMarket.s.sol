...
contract DeployPirexGMXMarket is BaseScript {
    ...
    function run() public {
        ...
        PirexGMXYieldSource source = new PirexGMXYieldSource();
        ...
        uint256 daily = 5e77;  // As of 6/5/22
        ...
        {
            string memory objName = "deploy_pxgmx";
            string memory json;
            ...
            if (eq(vm.envString("NETWORK"), "arbitrum")) {
                vm.writeJson(json, "./json/deploy_pxgmx.arbitrum.json");
            } else {
                vm.writeJson(json, "./json/deploy_pxgmx.localhost.json");
            }
        }
    }
}
